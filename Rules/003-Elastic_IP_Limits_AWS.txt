This Rule requires a Json Scanner, found in the JavaScript Plugin.

New Rule 3: Elastic IP Limits for AWS
...
Documentation Link: http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/elastic-ip-addresses-eip.html#using-instance-addressing-limit
